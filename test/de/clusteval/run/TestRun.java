...
public class TestRun extends TestRepositoryObject {
	...
	@Test
	public void testParsePOR1() throws RegisterException,
	...
	@Test
	public void testNetalPOR2() throws RegisterException,
			UnknownDataSetFormatException, GoldStandardNotFoundException,
			GoldStandardConfigurationException, DataSetConfigurationException,
			DataSetNotFoundException, DataSetConfigNotFoundException,
			GoldStandardConfigNotFoundException, NoDataSetException,
		...
		try {
			ParameterOptimizationRun.parseFromFile(new File(FileUtils
					.buildPath("testCaseRepository", "runs", "netal_2.run")));
		} catch (Exception ex) {
			Assert.assertEquals(RunException.class, ex.getClass());
			Assert.assertEquals(
	...
	@Test
	public void testNetalPOR3() throws RegisterException,
			UnknownDataSetFormatException, GoldStandardNotFoundException,
			GoldStandardConfigurationException, DataSetConfigurationException,
			DataSetNotFoundException, DataSetConfigNotFoundException,
			GoldStandardConfigNotFoundException, NoDataSetException,
		...
		try {
			ParameterOptimizationRun.parseFromFile(new File(FileUtils
					.buildPath("testCaseRepository", "runs", "netal_3.run")));
		} catch (Exception ex) {
			Assert.assertEquals(RunException.class, ex.getClass());
			Assert.assertEquals(
	...
	@Test
	public void testNetalPOR4() throws RegisterException,
			UnknownDataSetFormatException, GoldStandardNotFoundException,
			GoldStandardConfigurationException, DataSetConfigurationException,
			DataSetNotFoundException, DataSetConfigNotFoundException,
			GoldStandardConfigNotFoundException, NoDataSetException,
			...
			IncompatibleContextException, UnknownParameterType {
		ClustevalBackendServer.logLevel(Level.INFO);
		ParameterOptimizationRun.parseFromFile(new File(FileUtils.buildPath(
				"testCaseRepository", "runs", "netal_ok.run")));
	}
}
